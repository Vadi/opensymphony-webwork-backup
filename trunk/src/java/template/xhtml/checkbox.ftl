...
<#if parameters.tooltip?exists>
    <img src='<@ww.url value="/webwork/tooltip/tooltip.gif" includeParams='none' />' alt="${parameters.tooltip}" title="${parameters.tooltip}" onmouseover="return escape('${parameters.tooltip?js_string}');" />
</#if>
</label><#t/>
</#if>
    </td>
