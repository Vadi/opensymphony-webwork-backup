...
<body>
    ...
    <p/>
    For more information check out javadoc for com.opensymphony.webwork.interceptor.TokenInterceptor
    and com.opensymphony.webwork.interceptor.TokenSessionStoreInterceptor.
