...
<p>
    ...
    <ul>
        ...
        <li>updateFreq (can use altSyntax) - how often to update the contents. A value of 0 only updates the contents
            once.</li>
        <li>loadingText - the text to display to the user while the contents are loading the very first time</li>
        <li>reloadingText - the text to display to the user while the contents are reloading (every time after the very
            first time)</li>
        <li>errorText - the text to display to the user if there is an error (i.e. error contacting the url
            specified)</li>
        <li>showErrorTransportText (true/false, can use altSyntax) - whether you want to display the transports error
            text to the user</li>
...
<p>
    ...
    <div class="source">
        <pre>
            ...
            &lt;script language="JavaScript" type="text/javascript" src="&lt;ww:url value="/webwork/dojo/__package__.js"
            /&gt;"&gt;&lt;/script&gt;
        ...
        <div class="source">
            <pre>
                ...
                &lt;link rel="stylesheet" type="text/css" href="&lt;ww:url value="/webwork/niftycorners/niftyPrint.css"/&gt;"
                media="print"&gt;
