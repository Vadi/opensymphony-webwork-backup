...
<p>
    ...
    <ul>
        ...
        <li>updateFreq (can use altSyntax) - how often to update the contents. A value of 0 only updates the contents
            once.</li>
        <li>delay (can use altSyntax) - how long to wait before the first remote call. A value of 0 only updates the
            contents once.</li>
        ...
        <li>errorText - the text to display to the user if there is an error (i.e. error contacting the url
            specified)</li>
        <li>showErrorTransportText (true/false, can use altSyntax) - true if you want to display the dojo transports
            error, or the text to the user</li>
