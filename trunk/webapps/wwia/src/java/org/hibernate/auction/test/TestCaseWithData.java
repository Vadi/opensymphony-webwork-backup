...
public abstract class TestCaseWithData extends TestCase {
	...
	protected void initData() throws Exception {
		...
		// Users
		u1 = new User("Christian", "Bauer", "turin", "abc123", new Email("christian", "hibernate.org"));
		u1.setAddress(new Address("Foo", "12345", "Bar"));
		u1.setAdmin(true);
		u2= new User("Gavin", "King", "gavin", "abc123", new Email("gavin", "hibernate.org"));
		u2.setAddress(new Address("Foo", "12345", "Bar"));
		u3= new User("Max", "Andersen", "max", "abc123", new Email("max", "hibernate.org"));
