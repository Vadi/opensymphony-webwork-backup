...
-->
<tr>
<#if parameters.labelposition?default("") == 'top'><td align="left" valign="top" colspan="2"><#else><td align="right" valign="top"></#if><#if parameters.label?exists><label <#if parameters.id?exists> for="${parameters.id?html}}"</#if><#if hasFieldErrors> class="errorLabel"<#else> class="label"</#if>><#if parameters.required?default(false)><span class="required">*</span></#if>${parameters.label?html}:</label></#if></td>
<#-- add the extra row -->
