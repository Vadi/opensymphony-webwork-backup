...
<table border="0" cellpadding="2" cellspacing="0" width="400" bgcolor="#EEE">
...
<td bgcolor="<#if (index % 2) == 0>#EEE<#else>#FFF</#if>">${propertyName}</td>
<td bgcolor="<#if (index % 2) == 0>#EEE<#else>#FFF</#if>"><#if stackObject.value.get(propertyName)?exists>${stackObject.value.get(propertyName).toString()}<#else>null</#if></td>
</tr>
...
<tr bgcolor="<#if (index % 2) == 0>#EEE<#else>#FFF</#if>">
