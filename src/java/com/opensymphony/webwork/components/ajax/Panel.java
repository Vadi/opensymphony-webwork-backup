 ...
 * Time: 7:19:23 AM
 */
public class Panel extends ClosingUIBean implements JavascriptEmitter, Cloneable {
    ...
    public void end(Writer writer) {
        ...
        try {
            tabbedPanel.addTab((ContentPane) this.clone());
            ((TopicScope) findAncestor(TopicScope.class)).addEmitter((JavascriptEmitter) this.clone());
